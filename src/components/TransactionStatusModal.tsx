  ...
  return (
    ...
    >
      <div
        ...
        className={`bg-[#0e1117] border border-white/10 w-full max-w-md rounded-2xl p-6 relative shadow-[0_20px_60px_rgba(0,0,0,0.8)] transition-all duration-[950ms] ease-[cubic-bezier(0.16,1,0.3,1)] ${
      ...
      >
        ...
        <div className="mb-5">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-white/[0.04] border border-white/10 flex items-center justify-center text-white shadow-inner">
              {step === 'error' ? (
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-slate-400 font-mono mt-0.5 break-words text-[11px]">
                {step === 'success'
          ...
          {step === 'error' && errorMessage && (
            <div className="mt-3 p-3.5 rounded-xl bg-rose-950/40 border border-rose-800/60 text-xs font-mono text-rose-200 break-words">
              <div className="font-semibold text-rose-100 mb-1">Details:</div>
              {errorMessage}
            </div>
          )}
        </div>
        ...
        <div className="space-y-2 my-4 bg-black/40 rounded-xl p-3.5 border border-white/[0.06]">
