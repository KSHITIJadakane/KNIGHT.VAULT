...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#07090e] text-slate-100 relative selection:bg-emerald-500/30 selection:text-emerald-200 overflow-x-hidden">
      ...
      <div
        className={`flex-1 flex flex-col w-full transition-all duration-[1800ms] ease-[cubic-bezier(0.16,1,0.3,1)] ${
          isSceneVisible
            ? 'opacity-100 translate-y-0'
            : 'opacity-0 translate-y-12 pointer-events-none'
        }`}
        style={{
          transform: isSceneVisible ? 'translate3d(0, 0, 0)' : 'translate3d(0, 48px, 0)',
